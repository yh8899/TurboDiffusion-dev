...
DATASET_ROOT="/picassox/cephfs/optimization/yh7/datasets/worstcoder/Wan_datasets/wan2pt2_i2v"
...
torchrun --nproc_per_node=8 \
    -m scripts.train --config=turbodiffusion/rcm/configs/${registry}.py -- experiment=${experiment} \
        ...
        model.config.pretrained_ckpt_high=${CHECKPOINT_ROOT}/Wan2.2-I2V-14B-high.dcp \
        model.config.pretrained_ckpt_low=${CHECKPOINT_ROOT}/Wan2.2-I2V-14B-low.dcp \
